...
//   - Added `@preconcurrency import Tokenizers` (needed when compiled as a separate module with explicit imports).
...
public struct Gemma4Processor: UserInputProcessor {
    ...
    public init(_ config: Gemma4ProcessorConfiguration, tokenizer: any MLXLMCommon.Tokenizer) {
        self.config = config
